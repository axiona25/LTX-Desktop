...
export const viewTypeValues = ['home', 'project', 'modal-image-studio', 'character-studio', 'video-studio', 'editor-studio'] as const
...
export const generationParamsSchema = z.object({
  ...
  imageCharacterId: z.string().nullable().optional(),
  imageCharacterName: z.string().nullable().optional(),
  imageCharacterImagePath: z.string().nullable().optional(),
